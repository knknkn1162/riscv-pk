...
uintptr_t mcall_sm_stop_enclave(uintptr_t* regs, unsigned long request, unsigned int *hartid);
uintptr_t mcall_sm_resume_enclave(uintptr_t* regs, unsigned long eid, unsigned long req);
